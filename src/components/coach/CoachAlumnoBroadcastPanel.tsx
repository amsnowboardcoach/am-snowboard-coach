...
import { sendCoachAlumnoBroadcast } from "@/lib/firebase/coach-broadcast";
import { cn } from "@/lib/utils/cn";

interface CoachAlumnoBroadcastPanelProps {
  selectedIds: string[];
  onClearSelection?: () => void;
}

export function CoachAlumnoBroadcastPanel({
  selectedIds,
  onClearSelection,
}: CoachAlumnoBroadcastPanelProps) {
  ...
  async function handleSend() {
    ...
    try {
      const result = await sendCoachAlumnoBroadcast({
