    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-sm text-zinc-400">
          Supervisa y elimina anuncios del mercadillo entre alumnos. Los
          contactos (teléfono/email) solo los ves tú como coach.
        </p>
        <Link
          href="/mercadillo"
      ...
      {!loading && !error && listings.length === 0 && (
        <p className="rounded-xl border border-dashed border-zinc-700 py-12 text-center text-zinc-500">
          No hay anuncios activos en el mercadillo.
        </p>
      )}
