...
const keys = [
  ...
  "NEXT_PUBLIC_DEFAULT_COACH_ID",
  "NEXT_PUBLIC_COACH_EMAILS",
  "NEXT_PUBLIC_COACH_WHATSAPP",
  "NEXT_PUBLIC_COACH_WHATSAPP_DISPLAY",
  ...
  "GOOGLE_CALENDAR_ID",
  "GOOGLE_EXPLORA_CALENDAR_ID",
  "GOOGLE_BUSY_CALENDAR_IDS",
  "GOOGLE_MIRROR_CALENDAR_IDS",
  "SMTP_HOST",
  "SMTP_PORT",
  "SMTP_USER",
  "SMTP_PASS",
